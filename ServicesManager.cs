...
namespace PhoneStation
{
    public partial class ServicesManager : Form
    {
        ...
        private void ServicesManager_Load(object sender, EventArgs e)
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "phoneStationDataSet7.Service". При необходимости она может быть перемещена или удалена.
            this.serviceTableAdapter.Fill(this.phoneStationDataSet7.Service);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                serviceTableAdapter.Update(phoneStationDataSet7.Service);
            }
            catch (Exception ex)
            {

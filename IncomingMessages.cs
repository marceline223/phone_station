...
{
    public partial class IncomingMessages : Form
    {
        public int id_;
        public IncomingMessages(int id)
        {
            InitializeComponent();
            id_ = id;
            cn.Open();
        ...
        public void refresh()
        {
            listIncoming.Rows.Clear();
            loadList();
        }

        public void loadList()
        {
            OleDbCommand command = new OleDbCommand("showIncoming", cn);
            command.CommandType = CommandType.StoredProcedure;
            command.Parameters.AddWithValue("@idTo", id_);
